  ...
  if (cartNumberDom) {
    ...
    if (submitBtn) {
      submitBtn.addEventListener('click', function () {
        ...
        var currentNumber = parseInt(cartNumberDom.value) || 0;
